#!/usr/bin/env python3
"""
Script para probar la nueva funcionalidad de ayuda en facturas
"""
...
def probar_ayuda_facturas():
    """Probar la nueva funcionalidad de ayuda en facturas"""
    print("🔔 PROBANDO NUEVA FUNCIONALIDAD DE AYUDA EN FACTURAS")
    print("=" * 60)
    ...
    # 1. Probar carga de la página de facturas
    print("\n1️⃣ Probando carga de página de facturas...")
    try:
        ...
        if response.status_code == 200:
            ...
            if 'El botón verde' in content and 'alert alert-info' in content:
            ...
            if 'mostrarAyudaFacturas()' in content and 'Ayuda sobre Facturas' in content:
            ...
            print(f"  ❌ Error cargando facturas: {response.status_code}")
            return False
    ...
    try:
        with open('templates/core/facturas/list.html', 'r') as f:
            content = f.read()
...
def main():
    """Función principal"""
    print("🔔 PRUEBA DE AYUDA CONTEXTUAL EN FACTURAS")
    print("=" * 70)
    
    try:
        # Probar funcionalidad
        ayuda_ok = probar_ayuda_facturas()
        ...
        if ayuda_ok:
            ...
            print("  1. Ve a: http://localhost:8000/facturas/")
            print("  2. Observa que ya no hay notificaciones estáticas")
            print("  3. Haz clic en 'Ayuda sobre Facturas'")
